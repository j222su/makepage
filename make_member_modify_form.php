...
<script src="./js/make_modify.js?ver=1"></script>
...
<!-- 회원가입 -->
    <div id="main_content">
			<div id="joinInfo">
				...
				<div id="divModify">
          <form name="member_assign" action="make_member_modify.php" method="post">
            <table>
              <!-- 사용자ID -->
              <tr>
                <td class="tdFirst">
                ...
                <td>
                  <input id="userID" type="text" name="user_ID" value="<?=$userid?>" readonly>
            ...
            <tr>
              ...
              <td>
                <input id="pwpw" type="password" name="pwpw" value="<?=$pwpw?>">
            ...
            <tr>
              ...
              <td>
                <input id="pwChk" type="password" name="pwChk" value="<?=$pwpw?>">
            ...
            <tr>
              ...
              <td>
                <input id="inputEmail" type="email" name="email"  value="<?=$email?>" style="width : 230px">
            ...
            <button id="btnNext" type="button" name="button">회원정보수정 완료하기</button>
        </form>
      </div> <!--divMain -->
    </div> <!-- main_content -->
	</section>
